...
// Ring buffer depth (number of samples before host must drain).
// At 1000 S/s, 2048 samples = 2.048 s of buffering.
static constexpr uint16_t RING_BUF_SIZE    = 2048;    // must be a power of 2
