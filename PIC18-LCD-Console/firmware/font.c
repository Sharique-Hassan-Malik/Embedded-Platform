...
/*
 * Standard 5×7 column-major font.
 * Indexed by (char - 0x20).  Covers ASCII 0x20–0x5F.
 *
 * Each row of five bytes represents one glyph column-by-column.
 * Bit 0 is the topmost pixel; bit 6 is the bottom pixel.
 */
